...
#ifdef NEO_STYPE
# ifdef __GNUC__
#  pragma GCC message "bison: do not #define NEO_STYPE in C++, use %define api.value.type"
# endif
    typedef NEO_STYPE value_type;
#else
...
# endif
    ...
    {
      NEO__ASSERT (yytypeid_);
      NEO__ASSERT (*yytypeid_ == typeid (T));
      NEO__ASSERT (sizeof (T) <= size);
      return *yyas_<T> ();
    }
    ...
    {
      NEO__ASSERT (yytypeid_);
      NEO__ASSERT (*yytypeid_ == *that.yytypeid_);
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // any_parameter
      // list.0.N
      char dummy2[sizeof (command::param_t)];

      // parameters.0.N
      char dummy3[sizeof (command::parameters)];

      // instancedecl
      char dummy4[sizeof (command_instance)];
    ...
    /// Symbol locations.
    typedef neo::location location_type;
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_26_template_args_0_N = 26,             // template_args.0.N
        S_templatedecl = 27,                     // templatedecl
        S_commandname = 28,                      // commandname
        S_commanddecl = 29,                      // commanddecl
        S_instancedecl = 30,                     // instancedecl
        S_31_parameters_0_N = 31,                // parameters.0.N
        S_special_parameter = 32,                // special_parameter
        S_parameter = 33,                        // parameter
        S_any_parameter = 34,                    // any_parameter
        S_35_list_0_N = 35                       // list.0.N
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_35_list_0_N: // list.0.N
        value.move< command::param_t > (std::move (that.value));
        break;

      case symbol_kind::S_31_parameters_0_N: // parameters.0.N
        value.move< command::parameters > (std::move (that.value));
        break;

      case symbol_kind::S_instancedecl: // instancedecl
        value.move< command_instance > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_26_template_args_0_N: // template_args.0.N
        value.move< std::vector<std::string_view> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, command::param_t&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const command::param_t& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, command::parameters&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const command::parameters& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, command_instance&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const command_instance& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, command_template&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const command_template& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
      ...
      {}
#else
      basic_symbol (typename Base::kind_type t, const neo::text_content& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::string_view>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<std::string_view>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_any_parameter: // any_parameter
      case symbol_kind::S_35_list_0_N: // list.0.N
        value.template destroy< command::param_t > ();
        break;

      case symbol_kind::S_31_parameters_0_N: // parameters.0.N
        value.template destroy< command::parameters > ();
        break;

      case symbol_kind::S_instancedecl: // instancedecl
        value.template destroy< command_instance > ();
        break;
      ...
      case symbol_kind::S_26_template_args_0_N: // template_args.0.N
        value.template destroy< std::vector<std::string_view> > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
      ...
      symbol_type (int tok, neo::text_content v, location_type l)
        : super_type (token_kind_type (tok), std::move (v), std::move (l))
#else
      symbol_type (int tok, const neo::text_content& v, const location_type& l)
        : super_type (token_kind_type (tok), v, l)
#endif
      {
#if !defined _MSC_VER || defined __clang__
        NEO__ASSERT (tok == token::TEXT_CONTENTS);
#endif
      }
#if 201103L <= YY_CPLUSPLUS
    ...
    parser_impl (state_machine& __yyarg);
    virtual ~parser_impl ();
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_NEO_error (location_type l)
      {
        return symbol_type (token::NEO_error, std::move (l));
      }
#else
      static
      symbol_type
      make_NEO_error (const location_type& l)
      {
        return symbol_type (token::NEO_error, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_NEO_UNDEF (location_type l)
      {
        return symbol_type (token::NEO_UNDEF, std::move (l));
      }
#else
      static
      symbol_type
      make_NEO_UNDEF (const location_type& l)
      {
        return symbol_type (token::NEO_UNDEF, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_TEXT_CONTENTS (neo::text_content v, location_type l)
      {
      ...
      static
      symbol_type
      make_TEXT_CONTENTS (const neo::text_content& v, const location_type& l)
      {
  ...
  parser_impl::yytranslate_ (int t) YY_NOEXCEPT
  {
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_any_parameter: // any_parameter
      case symbol_kind::S_35_list_0_N: // list.0.N
        value.copy< command::param_t > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_31_parameters_0_N: // parameters.0.N
        value.copy< command::parameters > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_instancedecl: // instancedecl
        value.copy< command_instance > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_26_template_args_0_N: // template_args.0.N
        value.copy< std::vector<std::string_view> > (YY_MOVE (that.value));
        break;
  ...
  parser_impl::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_any_parameter: // any_parameter
      case symbol_kind::S_35_list_0_N: // list.0.N
        value.move< command::param_t > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_31_parameters_0_N: // parameters.0.N
        value.move< command::parameters > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_instancedecl: // instancedecl
        value.move< command_instance > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_26_template_args_0_N: // template_args.0.N
        value.move< std::vector<std::string_view> > (YY_MOVE (s.value));
        break;
  ...
  // by_kind.
  inline
  parser_impl::by_kind::by_kind () YY_NOEXCEPT
    : kind_ (symbol_kind::S_YYEMPTY)
  {}

#if 201103L <= YY_CPLUSPLUS
  inline
  parser_impl::by_kind::by_kind (by_kind&& that) YY_NOEXCEPT
    : kind_ (that.kind_)
  {
    that.clear ();
  }
  ...
  inline
  parser_impl::by_kind::by_kind (const by_kind& that) YY_NOEXCEPT
    : kind_ (that.kind_)
  {}

  inline
  parser_impl::by_kind::by_kind (token_kind_type t) YY_NOEXCEPT
  ...
  inline
  void
  parser_impl::by_kind::clear () YY_NOEXCEPT
  {
    kind_ = symbol_kind::S_YYEMPTY;
  }
